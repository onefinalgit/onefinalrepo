...
require.register("web/static/js/apartments", function(exports, require, module) {
"use strict";
...
var App = function () {
  ...
  _createClass(App, null, [{
    ...
    value: function init() {
      ...
      chan.on("new:register", function (msg) {
        $messages.append("<br/><i>[" + msg.user + " entered the fray]</i>");
      });

      chan.on("new:trebek", function (msg) {
        $messages.append("<br/><strong>[TREBEK IS HERE]</strong>");
      });

      chan.on("board:clear", function (msg) {
        $messages.empty();
...
;require.register("web/static/js/brjeopardy", function(exports, require, module) {
"use strict";
...
var Brjeopardy = function () {
  function Brjeopardy() {
    _classCallCheck(this, Brjeopardy);
  }

  _createClass(Brjeopardy, null, [{
    key: "init",
    value: function init() {
      var _this = this;
